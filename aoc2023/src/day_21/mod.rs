...
pub fn run() {
    let input_file: String = fs::read_to_string("src\\day_21\\input.txt").expect("File not found!");

    println!("\n--Day 21------");
    println!("Part 1: {}", &part1(&input_file, 64));
    println!("Part 2: {}", &part2(&input_file, 26501365));
    println!("--------------");
}
